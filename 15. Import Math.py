...
x = 10.32
y = 13.87
x_ceil = math.ceil(x) # ceil = pembulatan keatas
y_ceil = math.ceil(y)
print(x_ceil)
print(y_ceil)
...
x_floor = math.floor(x) # floor = pembualatan kebawah
...
x = 10.32
y = -13.87
x = math.fabs(x) # fabs = nilai absolut / tidak minus
y = math.fabs(y)
print(x)
print(y)
...
x_factorial = math.factorial(5) # faktorial dari 5
print(x_factorial)

# Fungsi math.fsum()
print(">>> Fungsi math.fsum()")
x = [1, 2, 3, 4, 5, 6, -6, -5, -4]
total = math.fsum(x) # sum dari x
print(total)

# Fungsi math.log()
print(">>> Fungsi math.log()")
# x = log basis 2 dari 8
x = math.log(8,2) # 2 log 8
# y = log basis 3 dari 81
y = math.log(81, 3) # 3 log 81
